          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-left mb-12">
              ...
              <p className="text-xl text-gray-600 mb-2">
                Each day, more than 3,000 kids, over one million a year, become
                regular smokers. One-third of them will die prematurely from
                tobacco-related diseases. Several factors contribute to this
                national health epidemic, including the roughly $5 billion
                tobacco companies spend each year on advertising and marketing
                to attract new smokers. More than 30% of our population smokes
                or chews. This deadly addiction kills more than 400,000
                Americans each year. More than 90% of all regular smokers began
                using tobacco at or before age 18!
              </p>
            </div>
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-6 w-6 text-gray-600 transform transition-transform duration-300 ${
                      expandedSection === "consequences" ? "rotate-180" : ""
                    }`}
                  />
                </button>
                <AnimatedSubmenu isOpen={expandedSection === "consequences"}>
                ...
                <AnimatedSubmenu isOpen={expandedSection === "oralCare"}>
                  <div className="px-6 pb-6">
                    <p className="text-xl font-bold text-gray-900 mb-4">
                      If you have any of these symptoms, perform an oral cancer
                      self examination by:
                    </p>
                    <div className="space-y-1.5">
                    ...
                    <p className="text-xl text-gray-600 mt-4">
                      If you find anything unusual call us immediately and tell
                      our receptionist about your findings so we can get you in
                      quickly.
                    </p>
                  </div>
                </AnimatedSubmenu>
            ...
            <div className="text-left mt-6 mb-12">
              ...
              <div className="bg-white rounded-lg p-6 mb-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xl text-gray-600 font-semibold">
                    Smokers are at risk for periodontal disease FOUR TIMES more
                    than nonsmokers!
                  </p>
                </div>
                <p className="text-xl text-gray-600 mt-4">
              ...
              <p className="text-xl text-gray-600">
                Call 1-866-632-7848 for information, support and follow-up calls
                as often as you need, anytime, day or night. Certified
                ...
                offered on a regular schedule to provide ongoing support, advice
                and encouragement. There is no limit to the number of follow up
                sessions or calls for support. All information is confidential.
              </p>
              <p className="mt-4 text-l text-gray-600">
                <span className="font-bold">PLEASE NOTE:</span> The information
                contained herein is intended for educational purposes only. It
                is not intended and should not be construed as the delivery of
                dental/medical care and is not a substitute for personal hands
                on dental/medical attention, diagnosis or treatment. Persons
                requiring diagnosis, treatment, or with specific questions are
                urged to contact your family dental/health care provider for
                appropriate care. This site is privately and personally
                sponsored, funded and supported by Drs. John P. & Theodore C.
                Ritota We have no outside funding. Confidentiality of data
                including your identity, is respected by this Web site. We
                undertake to honor or exceed the legal requirements of
                medical/health information privacy that apply in Florida.
              </p>
            </div>
          </div>
        </Container>
