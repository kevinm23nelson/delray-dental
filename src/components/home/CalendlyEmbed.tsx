...
const CalendlySkeletonLoader = () => (
  <div className="absolute inset-0 flex items-start justify-center lg:pt-[40px]">
    <div
      ...
      <div className="mb-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            <ChevronLeft className="text-gray-300 h-6 w-6" />
            <div className="h-5 w-36 bg-gray-200 rounded"></div>
            <ChevronRight className="text-gray-300 h-6 w-6" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-7 gap-2 mb-4">
          {[...Array(7)].map((_, i) => (
            <div key={i} className="h-5 w-10 bg-gray-200 rounded mx-auto"></div>
          ))}
        </div>
  ...
  return (
    <div className="w-full animate-in fade-in duration-700 ease-in-out bg-gray-100 xl:pl-[4rem] lg:px-6">
      <div className="lg:flex lg:pl-[10rem]">
        <div className="lg:w-1/3 lg:mt-[4em] lg:pl-[1rem]">
          <AnimatedContent>
            <div className="text-center lg:text-left mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-in-out">
              <h2 className="text-3xl sm:text-3xl font-bold text-gray-900 font-montserrat mb-4">
                ...
                {(
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-base opacity-90">{event.duration}</p>
                      <p
          ...
          <div className="lg:w-2/3">
            <div className="bg-gray-100">
              <div className="relative">
                ...
                <div
                  className={`calendly-inline-widget lg:scale-[.86] !overflow-hidden bg-gray-100 rounded-lg transition-opacity duration-300 ${
